...
/**
 * A database that stores Repos information.
...
abstract class ReposDatabase : RoomDatabase() {
     ...
     */
    abstract val reposDatabaseDao: ReposDatabaseDao

    /**
     * Define a companion object, this allows us to add functions on the ReposDatabase class.
     *
     * For example, clients can call `ReposDatabase.getInstance(context)` to instantiate
     * a new ReposDatabase.
     */
    companion object {
        /**
